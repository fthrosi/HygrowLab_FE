    ...
    <div
      className={`min-h-screen gap-4 shrink-0 pt-9 transition-all duration-300 ease-in-out bg-primary ${
        open
          ...
          : "xl:w-[70px] md:px-1 xl:px-2 w-0 md:w-[70px]"
      }`}
    >
      <div>
        <div
        ...
        >
          ...
          >
            ...
            <h1
              className={`nunito font-bold text-[1.563rem] text-white ${
                open ? "" : "hidden"
              }`}
            >
              HygrowLab
        ...
        <ul className={`mt-10 flex flex-col gap-4 xl:px-2`}>
          <li>
            ...
            >
              <svg
                className="xl:size-7 size-[clamp(1.25rem,6.25vw,1.5rem)]"
                viewBox="0 0 20 20"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <h1
                className={`${
                  open ? "" : "hidden"
                } text-[clamp(1.25rem,6.25vw,1.5rem)] md:text-[1.25rem]`}
              >
                Dashboard{" "}
              </h1>
            </Link>
          ...
          <li>
            ...
            >
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_310_15462)">
                  <path
