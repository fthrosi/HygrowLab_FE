  ...
  return (
    <div className="fixed w-full">
      ...
      >
        ...
        <Link to="/login" className="font-bold button px-[2rem] py-[0.5rem] bg-primary text-white rounded-[0.438rem] hidden lg:block lg:px-[1.5rem] lg:py-[0.3rem] hover:cursor-pointer">
