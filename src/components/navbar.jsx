  ...
  return (
    <div className="fixed w-full">
      ...
      >
        ...
        <div
          className={`flex justify-between w-full md:w-auto px-[2rem] md:px-0 md:py-0 py-4 ${
            scroll ? 'shadow-md bg-white md:shadow-none md:bg-transparent' : ''
          }`}>
        ...
        <a
          href="/login"
          className="font-bold button px-[2rem] py-[0.5rem] bg-primary text-white rounded-[0.438rem] hidden lg:block">
          Masuk
        </a>
